...
# for a given board state. Peers are every member in the same row, column or
# 3x3 square as a given member; every member has 20 peers (plus himself
# potentially)

# Peers are the simple means to propagate possibles. Every time we assign a 
# value to a member, we go through his peers and remove that value from
# their list of possibles.

# I make use of two dictionaries for this, where each board coordinate is a
# key and the key's value is a list of possibles and a list of peers
# respectively.
